...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new CheckoutPage().enterFirstName("Disha");
        new CheckoutPage().enterLastName("Patel");
        new CheckoutPage().enterEmailId("DishaPatel");
        new CheckoutPage().enterTelephone("078789654658");
        new CheckoutPage().enterAddressLine1("20,Harrow road");
        new CheckoutPage().enterCity("Harrow");
        new CheckoutPage().enterPostCode("Ha2 6Pb");
